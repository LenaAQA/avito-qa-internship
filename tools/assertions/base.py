...
def assert_is_not_none(actual: Any, name: str):
    """
    Проверяет, что значение не равно None.

    :param name: Название проверяемого значения.
    :param actual: Фактическое значение.
    :raises AssertionError: Если значение равно None.
    """
    logger.info(f"Check that '{name}' is not None")

    assert actual is not None, (
        f"Incorrect value: '{name}'. Expected non-null value. Actual value: {actual!r}."
    )
